...
| 기준 | 설명 | 가중치 |
|---|---|:--:|
| 비전·역할 정합 | "Remember More" / Trusted Workmate 부합 | ×1.5 |
| 6키워드 표현력 | Continuous~Accessible 연상 | ×1.0 |
| 발음·기억성 | 한/영 발음 용이, 음절 | ×1.0 |
| 충돌 안전성 | 검증 결과(✅ 우대) | ×1.5 |
| 글로벌·도메인 확장 | 식별력·도메인 가용 | ×1.0 |
| 카카오 톤 | 친근+전문 균형 | ×0.5 |

(각 5점 만점 · 가중 합계 만점 32.5)

### 9.2 스코어 결과 (상위 → 하위)
| 순위 | 이름 | 정합 | 키워드 | 발음 | 안전 | 확장 | 톤 | **합계** |
|:--:|---|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| **1** | **Mediory** | 5 | 4 | 4 | 5 | 4 | 4 | **29.0** |
| **2** | **Anavi** | 4 | 4 | 5 | 5 | 4 | 3 | **28.0** |
| **3** | **Noeta** | 3 | 3 | 4 | 5 | 4 | 3 | **24.5** |
| **4** | **Maru** | 2 | 2 | 5 | 5 | 3 | 5 | **23.0** |
| **5** | **Recordia** | 4 | 4 | 4 | 3 | 3 | 3 | **23.0** |
| 6 | Mnema | 4 | 3 | 2 | 5 | 3 | 2 | 22.5 |
| 7 | Remira | 4 | 3 | 4 | 3 | 3 | 3 | 22.0 |
| 8 | Lucen | 3 | 3 | 4 | 3 | 3 | 3 | 20.5 |
| 8 | Clina | 3 | 3 | 4 | 3 | 3 | 3 | 20.5 |
| 10 | Cleon | 3 | 2 | 4 | 3 | 3 | 3 | 19.5 |
| 10 | 곁 Gyeot | 4 | 3 | 3 | 3 | 1 | 4 | 19.5 |
| 12 | Vireon | 3 | 3 | 3 | 3 | 3 | 2 | 19.0 |
| 12 | Comra | 4 | 2 | 3 | 3 | 2 | 3 | 19.0 |
| 14 | 온차트 OnChart | 3 | 3 | 4 | 2 | 2 | 4 | 18.5 |
| 14 | Onda | 3 | 3 | 4 | 2 | 2 | 4 | 18.5 |
| 14 | Anamne | 4 | 3 | 2 | 3 | 2 | 2 | 18.5 |
| 17 | 결 Gyeol | 3 | 3 | 3 | 3 | 1 | 4 | 18.0 |
| 18 | Anvi | 3 | 2 | 4 | 2 | 2 | 3 | 17.0 |
| 19 | 이음 Ieum | 3 | 3 | 3 | 2 | 1 | 4 | 16.5 |
| 19 | Vitalo ⚠️ | 3 | 3 | 4 | 1 | 2 | 3 | 16.5 |

### 9.3 Top 5 (정량 결과)
1. **Mediory (29.0)** — 비전 직역·검증 클린. 전 영역 균형 최상.
2. **Anavi (28.0)** — 임상 어원·발음 우수·검증 클린.
3. **Noeta (24.5)** — 임상 지능 콘셉트·검증 클린.
4. **Maru (23.0)** — 발음·카카오 톤 최상(단, 식별력 보강 필요), 검증 클린.
5. **Recordia (23.0)** — 기록 메시지 강점(단, ◽ 미검증 → 클리어런스 우선).
...
> ⚠️ **베스트-에포트 사전점검**입니다. 확정 판단은 KIPRIS 정식검색 + 변리사 검토, 도메인은 등록대행 whois 필요.
> 도메인 자동조회는 **실행 환경의 DNS 차단**으로 미수행(참고: `host google.com`도 미해석되어 자동결과 무효 처리).

### 10.1 클리어런스 매트릭스
| 후보 | 상표 — 헬스(44류) | 상표 — SW/SaaS(9·42류) | 도메인(.com/.ai) | SNS 핸들 | 종합 |
|---|---|---|---|---|:--:|
| **Mediory** | 미발견(청정) | 미발견(청정) | 코인드어 → 확보 유망(whois 확인) | 확보 유망 | **★ 양호** |
| **Noeta** | 미발견(청정) | 미발견(청정) | 코인드어 → 확보 유망 | 확보 유망 | **◎ 양호** |
| Anavi | 미발견 | ⚠️ ANAVI Technology(오픈소스 HW), Anavi Group/Innovations 등 다수 | 흔함 → 경합 가능 | @anavi 경합 | △ 주의 |
| Maru | 미발견 | ⚠️ MARU(의류 25류 등록), Maruho(일본 피부과 제약) 인접, 일반어 희석 | maru.com 선점 유력 | @maru 선점 유력 | △ 주의 |

### 10.2 해석
- **Mediory**: 전 분야 동명 브랜드 미발견. 코인드어라 상표 식별력·도메인·핸들 확보 가능성 모두 최상. **클리어런스 관점 최우선.**
- **Noeta**: 동명 브랜드 미발견. Mediory와 함께 안전군. 단, 비전 정합은 Mediory가 우위.
- **Anavi**: 어학적 매력은 크나 **AI EHR가 속하는 SW 상표(9·42류)에 ANAVI 선행 사용자가 존재** → 정면 충돌 가능. 변리사 정밀검토 전제 없이는 비권장.
- **Maru**: 식별력이 약하고(일반어) 제약·의류 등 인접 사용으로 도메인·핸들 확보 난도 높음 → 후순위.

### 10.3 클리어런스 반영 권고
1. **Mediory** — 1순위 (비전 정합 + 클리어런스 모두 최상)
2. **Noeta** — 2순위 / 백업 (클리어런스 양호, 임상 지능 콘셉트)
